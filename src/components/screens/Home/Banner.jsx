      ...
      <Container>
        <Flex className="items-center gap-10">
          <div data-aos="fade-right" className="w-1/2">
            ...
            <Link className="mt-10 inline-flex items-center gap-2 rounded-lg border-[3px] border-white px-10 py-3 font-semibold text-white duration-300 ease-in-out hover:gap-4 hover:bg-white hover:text-black xl:text-base 2xl:text-lg">
          ...
          <div className="w-1/2">
            <div
              data-aos="fade-left"
              className="border-white-700 relative h-[400px] w-full rounded-lg border-[5px] p-3 shadow-customOne"
            >
              <Image
